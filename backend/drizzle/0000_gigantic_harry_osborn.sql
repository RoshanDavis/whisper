...
CREATE INDEX "idx_contacts_owner_id" ON "contacts" ("owner_id");--> statement-breakpoint
CREATE INDEX "idx_messages_sender_receiver" ON "messages" ("sender_id", "receiver_id");--> statement-breakpoint
